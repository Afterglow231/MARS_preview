...
class Request:
    ...
    def __init__(
        ...
        # Agent-session metadata propagated from SamplingParams.extra_args.
        # These fields identify multi-turn workflows and tool-call boundaries for MARS and other session-aware scheduling policies.
        self.job_id = job_id
    ...
    def from_engine_core_request(
        ...
        # Extract optional agent-session metadata from SamplingParams.extra_args.
        job_id = None
        last_func_call = None
        is_last_step = None
        this_func_call = None
